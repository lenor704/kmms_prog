...
namespace ule {
	...
	void HorizonMoveObject (TObject *obj, TObject *mario, TObject *&brick, int &brickLength, TObject *&moving, int &movingLength, int &level); //!!!
	void InitObject(TObject *obj, float xPos, float yPos, float oWidth, float oHeight, char inType);
	bool IsCollision(TObject o1, TObject o2);
	bool IsPosInMap(int x, int y);
	void MarioCollision(TObject mario, TObject *&brick, int &brickLength, TObject *&moving, int &movingLength, int &level); //!!!! 
	void PlayerDead(TObject &mario, TObject *&brick, int &brickLength, TObject *&moving, int &movingLength, int &level); //!
	...
	void VertMoveObject(TObject *obj, TObject *mario, TObject *&brick, int &brickLength, TObject *&moving, int &movingLength, int &level); //!
}
